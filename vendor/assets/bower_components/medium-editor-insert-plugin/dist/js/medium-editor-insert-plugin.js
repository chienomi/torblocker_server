...
this["MediumInsert"]["Templates"]["src/js/templates/core-buttons.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  //   + "    </ul>\n</div>\n";
  return "<div class=\"medium-insert-buttons medium-insert-image-active\" contenteditable=\"false\" style=\"display: none\"> <button type=\"button\" data-addon=\"images\" data-action=\"add\" class=\"medium-insert-buttons-show\"><i class=\"fa fa-camera-retro\" aria-hidden=\"true\"></i></button> </div> ";
},"useData":true});
...
this["MediumInsert"]["Templates"]["src/js/templates/embeds-toolbar.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"medium-insert-embeds-toolbar medium-editor-toolbar medium-toolbar-arrow-under medium-editor-toolbar-active\"> <ul class=\"medium-editor-toolbar-actions clearfix\"> "
  ...
  return " <li> <button class=\"medium-editor-action\" data-action=\""
    + container.escapeExpression(((helper = (helper = helpers.key || (data && data.key)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"key","hash":{},"data":data}) : helper)))
    + "\">"
    + ((stack1 = ((helper = (helper = helpers.label || (depth0 != null ? depth0.label : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"label","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "</button> </li> ";
  ...
  return " <div class=\"medium-insert-embeds-toolbar2 medium-editor-toolbar medium-editor-toolbar-active\"> <ul class=\"medium-editor-toolbar-actions clearfix\"> "
...
this["MediumInsert"]["Templates"]["src/js/templates/embeds-wrapper.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"medium-insert-embeds\" contenteditable=\"false\"> <figure> <div class=\"medium-insert-embed\"> "
    ...
    + " </div> </figure> <div class=\"medium-insert-embeds-overlay\"></div> </div>";
},"useData":true});
...
this["MediumInsert"]["Templates"]["src/js/templates/images-image.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " <br> <figure contenteditable=\"false\"><img src=\""
...
this["MediumInsert"]["Templates"]["src/js/templates/images-toolbar.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "	<div class=\"medium-insert-images-toolbar2 medium-editor-toolbar medium-editor-toolbar-active\"> <ul class=\"medium-editor-toolbar-actions clearfix\"> "
  ...
  return "<div class=\"medium-insert-images-toolbar medium-editor-toolbar medium-toolbar-arrow-under medium-editor-toolbar-active\"> <ul class=\"medium-editor-toolbar-actions clearfix\"> "
...
;(function ($, window, document, undefined) {
    ...
    Core.prototype.events = function () {
        ...
        this.$el
            ...
            .on('click', '.medium-insert-buttons-show', $.proxy(this, 'addonAction'))
